...
import { Box, Avatar, Typography, Button, Badge, IconButton } from '@mui/material';
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="subtitle1" sx={{ fontWeight: 'bold', color: 'white', ml: 2, fontSize: '18px' }}>
            Username
          </Typography>
        </Box>
        <Button
          variant="contained"
          sx={{ backgroundColor: '#08D2ED', color: 'white', textTransform: 'none' }}
      ...
      >
        ...
        {/* View-count */}
        <Box sx={{ position: 'absolute', top: 16, right: 16, display: 'flex', alignItems: 'center', zIndex: 3, gap: 1 }}>
