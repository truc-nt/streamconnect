...
func initServer() server.IServer {
	...
	iLivestreamService := service.NewLivestreamService(iLivestreamRepository, iLivestreamProductRepository, iLivestreamExternalVariantRepository, iVideoSdkAdapter)
	iLivestreamHandler := handler.NewLivestreamHandler(iLivestreamService)
	iLivestreamProductService := service.NewLivestreamProductService(iLivestreamProductRepository, iLivestreamExternalVariantRepository, v)
	...
	iOrderService := service.NewOrderService(iOrderRepository, iVoucherRepository, iOrderItemRepository, iOrderItemLivestreamExternalVariantRepository, iCartItemRepository, iExternalOrderRepository, iUserRepository, iUserAddressRepository, v)
