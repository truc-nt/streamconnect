...
func newProductTableImpl(schemaName, tableName, alias string) productTable {
	var (
		...
		allColumns        = postgres.ColumnList{IDProductColumn, FkShopColumn, NameColumn, DescriptionColumn, StatusColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns    = postgres.ColumnList{FkShopColumn, NameColumn, DescriptionColumn, StatusColumn, CreatedAtColumn, UpdatedAtColumn}
	)
