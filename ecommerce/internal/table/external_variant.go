...
type externalVariantTable struct {
	...
	IDExternalProduct postgres.ColumnString
	IDExternal        postgres.ColumnString
...
func newExternalVariantTableImpl(schemaName, tableName, alias string) externalVariantTable {
	var (
		...
		IDExternalProductColumn = postgres.StringColumn("id_external_product")
		IDExternalColumn        = postgres.StringColumn("id_external")
		...
		allColumns              = postgres.ColumnList{IDExternalVariantColumn, FkExternalShopColumn, FkVariantColumn, IDExternalProductColumn, IDExternalColumn, NameColumn, SkuColumn, StockColumn, OptionColumn, PriceColumn, ImageURLColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns          = postgres.ColumnList{FkExternalShopColumn, FkVariantColumn, IDExternalProductColumn, IDExternalColumn, NameColumn, SkuColumn, StockColumn, OptionColumn, PriceColumn, ImageURLColumn, CreatedAtColumn, UpdatedAtColumn}
	)
	...
	return externalVariantTable{
		...
		IDExternalProduct: IDExternalProductColumn,
		IDExternal:        IDExternalColumn,
		Name:              NameColumn,
		Sku:               SkuColumn,
		Stock:             StockColumn,
		Option:            OptionColumn,
